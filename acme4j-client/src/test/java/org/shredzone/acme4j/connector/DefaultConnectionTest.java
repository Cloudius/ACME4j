...
public class DefaultConnectionTest {
    ...
    public void testGetLink() throws Exception {
        ...
        headers.put("Location", Collections.singletonList("https://example.com/acme/acct/asdf"));
    ...
    public void testAcceptThrowsUserActionRequiredException() throws Exception {
        ...
        linkHeader.put("Link", Collections.singletonList("<https://example.com/tos.pdf>; rel=\"terms-of-service\""));
    ...
    public void testAcceptThrowsRateLimitedException() throws Exception {
        ...
        Map<String, List<String>> linkHeader = new HashMap<>();
        linkHeader.put("Link", Collections.singletonList("<https://example.com/rates.pdf>; rel=\"help\""));
    ...
    public void testSendSignedRequest() throws Exception {
        ...
        try (DefaultConnection conn = new DefaultConnection(mockHttpConnection) {
            ...
            public String getNonce() {
                assertThat(session, is(sameInstance(DefaultConnectionTest.this.session)));
                if (session.getNonce().equals(nonce1)) {
                    return nonce2;
                } else {
                    fail("unknown nonce");
                    return null;

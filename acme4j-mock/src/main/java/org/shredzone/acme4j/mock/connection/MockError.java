...
public final class MockError {
     ...
     * error.
     *
     * @param requestUrl {@link URL} the client tried to access
     * @param error      ACME error (e.g. {@code "unauthorized"}). The ACME error name space will be
     ...
     *
     * @param requestUrl {@link URL} the client tried to access
     * @param instance   {@link URL} the user must be pointed to in order to resolve the situation
     * @param tos        Optional {@link URI} of the new terms of service document
     ...
     *
     * @param requestUrl {@link URL} the client tried to access
     * @param rateLimits Optional collection of {@link URL} explaining which rate limits have been
     *                   reached.
     * @param retryAfter Optional instant after which the rate limit will be lifted.
